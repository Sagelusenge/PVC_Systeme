...
const roleGuides = {
  ...
  "Responsable production": {
    ...
    actions: [
      ...
      ["Code automatique", "Attribue le prochain code PF lors de l'enregistrement."],
      ["Etat PDF", "Exporte le stock des produits finis et sa valorisation."],
...
const actionContents = {
  ...
  "Code automatique": ["Le prochain numero libre au format PF-0001.", "Le serveur attribue le code pour eviter les doublons."],
  "Etat PDF": ["Les lignes de l'etat actif et leur valorisation.", "Un document date, pagine et telechargeable."],
